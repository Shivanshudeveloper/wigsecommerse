...
const Navigation = () => {
  ...
  const register = (event) => {
    ...
    auth
      .createUserWithEmailAndPassword(formData1.email, formData1.password)
      .then((result) => {
        const { user } = result;
        ...
        user
          .updateProfile({
            ...
            displayName: `${formData1.fullName}`,
          })
          .then(async () => {
            sessionStorage.setItem("login", true);
      ...
      >
        ...
        <DialogContent>
          ...
          <TextField
            ...
            onChange={(e) =>
              setFormData1({ ...formData1, confirmPassword: e.target.value })
            }
          />
          ...
          <div className="brand-and-icon">
            <div>
              <a href="/" className="navbar-brand">
                {width > 992 ? (
                  <img
                    src={`${process.env.PUBLIC_URL}/website.jpg`}
                    alt=""
                    style={{
                      height: "100px",
                      width: "200px",
