...
const Compare = () => {
  ...
  React.useEffect(() => {
    ...
    axios
      .get(`${API_SERVICE}/api/v1/main/findallthecartitems/${uid}`)
      .then((response) => {
  ...
  const deleteItem = (documentId) => {
    ...
    docRef
      ...
      .then(function (doc) {
        ...
        axios
          .get(`${API_SERVICE}/api/v1/main/removeitemtocart/${documentId}`)
          .then((response) => {
